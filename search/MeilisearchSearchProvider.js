import { groupResultsBySource } from "./resultFilters.js?v=search-20260823-8";
import { collapseDuplicateResults } from "./resultIdentity.js?v=search-20260823-8";
import { SOURCE_BY_ID, SOURCE_ORDER } from "./sourceConfig.js?v=search-20260823-8";
import { resolveKnownEntityDocumentQuery } from "./knownEntities.js?v=search-20260823-8";
import { isStandaloneConsonantOnlySearch, normalizeQuery, normalizeWidthText } from "./normalizeQuery.js?v=search-20260823-8";
import { isExactSourceDocumentMatch, resolveExactSourceQuery } from "./sourceQuery.js?v=search-20260823-8";
...
import { getOperatorSearchSuggestions } from "./suggestions.js?v=search-20260823-8";
import {
  createEmptySearchResult,
  DEFAULT_SEARCH_INDEX_NAME,
  DEFAULT_SUGGESTION_INDEX_NAME,
  normalizeSearchFilters,
} from "./SearchProvider.js?v=search-20260823-8";
import { normalizeSearchDocument } from "./schemas.js?v=search-20260823-8";
